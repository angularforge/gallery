...
import { GalleryImage, LightboxImage } from '../../../interface';
...
export class HorizontalGalleryComponent {
  ...
  @Output() readonly galleryImageClick = new EventEmitter<{ image: GalleryImage, index: number }>();
  ...
  onGalleryImageClick(image: GalleryImage, index: number) {
